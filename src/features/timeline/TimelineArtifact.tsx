...
const MOCK_EVENTS = [
  ...
  { id: 2, type: 'system', title: 'Queue Configuration Updated', time: '09:30 AM', user: 'System Admin', desc: 'Changed routing strategy to "Least Recent".', icon: Settings, color: 'text-violet-400', bg: 'bg-violet-400/10' },
